...
export const signUp = (data) => {
  return async (dispatch) => {
    try {
      ...
      const res = await axios.post("http://localhost:9203/signup", user);
      console.log(res);
      dispatch({
        type: AUTH_SIGN_UP,
        payload: res.data,
...
export const signIn = (data) => {
  return async (dispatch) => {
    try {
      const res = await axios.post("http://localhost:9203/signin", data);
      console.log(res);
      dispatch({
        type: AUTH_SIGN_IN,
        payload: res.data,
  ...
  return async (dispatch) => {
    try {
      const res = await axios.post(
        "http://localhost:9201/flights/search",
        data
      );
      console.log(res.data);
